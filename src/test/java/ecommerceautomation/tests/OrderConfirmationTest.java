...
public class OrderConfirmationTest extends BaseTest {
    ...
    public void verifyOrderConfirmation(String name, String email, String password,
        ...
        Assert.assertTrue(getDriver().getCurrentUrl().contains(config.getProperty("baseURL")), "Not redirected to the home page after clicking 'Continue'.");
    }
}